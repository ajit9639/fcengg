                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="Computer" role="tabpanel">
                        <ul>
                            ...
                            <li><a href="">Dimension Measurement</a></li>

                            <li><a href="">Electrical</a></li>

                            <li><a href="">Electronics &amp; Robotics</a></li>

                            <li><a href="">Fasteners</a></li>

                            <li><a href="">Furniture, Hospitality and Food Service</a></li>
                            ...
                            <div class="footer_contact">
                                <div class="footer_contact_inner">
                                    ...
                                    <div class="contact_text">
                                        <p>Hotline Free 24/7: <br> <strong>0123456789</strong></p>
                                    </div>
                                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="copyright_area">
                            <p>&copy; 2021 <a href="index.html" class="text-uppercase">Fire Care Engineers</a></p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="copyright_area" style="float:right;">
                            <p>Powered By<a href="https://insightinfosystem.com " class="text-uppercase ">Insight Infosystem</a></p>
                        </div>
                    </div>
                </div>
            </div>
